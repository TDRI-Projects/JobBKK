...
class jobBKKSpider3(CrawlSpider):
    name = "jobBKKNotUrgent"
    ...
    rules = [
        ...
        Rule(LinkExtractor(restrict_xpaths ='//*[@class="jobbkk-applying-work"]'), callback="parse", follow=True)
    ...
    def check_date(self, response):
        last_posting = response.xpath('string(//*[@class="textSky"]')[-1].extract().strip()
